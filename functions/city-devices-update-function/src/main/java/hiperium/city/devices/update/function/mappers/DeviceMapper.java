package hiperium.city.devices.update.function.mappers;
...
public interface DeviceMapper {
    ...
    @Mapping(target = "version",    expression = "java(getVersionValueFromAttributesMap(itemAttributesMap))")
    ...
    Device toDevice(Map<String, AttributeValue> itemAttributesMap);
     ...
     */
    DeviceResponse toDeviceResponse(Device device, int httpStatus, String errorMessage);
    ...
    /**
     * Retrieves the long value associated with the specified key from the given attributes map.
     *
     * @param attributesMap the map containing the attribute values
     * @param key           the key of the desired value
     * @return the long value associated with the key if it exists, or null if the key is not present in the map
     */
    default Long getLongValueFromAttributesMap(Map<String, AttributeValue> attributesMap, String key) {
        return attributesMap.containsKey(key) ? Long.valueOf(attributesMap.get(key).n()) : null;
    }
    ...
    /**
     * Retrieves the version value from the given attributes map based on the specified key.
     *
     * @param itemAttributesMap The map of attributes.
     * @return The version value associated with the specified key.
     */
    default Long getVersionValueFromAttributesMap(Map<String, AttributeValue> itemAttributesMap) {
        return this.getLongValueFromAttributesMap(itemAttributesMap, Device.VERSION_COLUMN_NAME);
    }
}
