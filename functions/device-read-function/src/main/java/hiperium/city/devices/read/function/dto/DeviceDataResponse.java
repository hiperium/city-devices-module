...
public record DeviceDataResponse(
    ...
    public static class Builder {
        ...
        /**
         * Sets the deviceStatus of the device.
         *
         * @param status the deviceStatus to set for the device
         * @return the builder instance
         */
        public Builder deviceStatus(DeviceStatus status) {
            this.deviceStatus = status;
            return this;
        }

        /**
         * Sets the HTTP deviceStatus of the DeviceDataResponse.
         *
         * @param httpStatus The HTTP deviceStatus to set.
        ...
        public DeviceDataResponse build() {
            return new DeviceDataResponse(id, name, cityId, deviceStatus, httpStatus, errorMessage);
        }
    }
}
