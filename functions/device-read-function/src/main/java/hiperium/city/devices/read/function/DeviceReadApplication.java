...
/**
 * The DeviceReadApplication class is the entry point for running the application.
 * It is annotated with @SpringBootApplication, indicating that it is a Spring Boot application.
 */
@SpringBootApplication
public class DeviceReadApplication {

    /**
     * The main method of the DeviceReadApplication class.
    ...
    public static void main(String[] args) {
        SpringApplication.run(DeviceReadApplication.class, args);
    }
}
