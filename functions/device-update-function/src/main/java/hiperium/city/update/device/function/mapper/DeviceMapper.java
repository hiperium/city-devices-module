package hiperium.city.update.device.function.mapper;
...
public interface DeviceMapper {
    ...
    @Mapping(target = "deviceStatus", source = "newDeviceStatus")
    Device mapToDeviceWithNewStatus(Map<String, AttributeValue> itemAttributesMap, DeviceStatus newDeviceStatus);
